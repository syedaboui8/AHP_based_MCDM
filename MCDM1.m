% TAKE A NOTE FROM LINE 26 TO 31
%% clear screen %%
...
% OR'modTOPSIS' OR 'ARAS'. IN CASE YOU WANT TO COMPUTE THE WEIGHTS USING
% AHP THEN 'COMMENT' (ADD THE % SIGN) THE LINE NO.40,49, 65, 95 & 146 
% 'UNCOMMENT (REMOVE THE % SIGN) THE LINE NOS. 41, 50, 66, 96 & 147
%  AND VICE VERSA WHEN YOU WANT TO COMPUTE THE WEIGHTS USING CROSS ENTROPY.
